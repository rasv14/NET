...
Public Class Crt_facturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Control_Pedidos.Crt_facturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrt_facturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crt_facturas = New Crt_facturas()
        rpt.Site = Me.Site
        Return rpt
    End Function
