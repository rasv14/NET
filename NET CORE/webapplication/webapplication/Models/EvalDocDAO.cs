...
{
    public class EvalDocDAO
    {

        public EvalDocDAO(IConfiguration configuration)
        {
        ...
        public DataTable GetResultados_paginados(String p_data, String page, String limit)
        {
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                //COMMENT_BDTEST: objCmd.CommandText = "COMUMGR.PKC_UPAO_CANVAS_CSV.PKC_GET_CSV";
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_CANV_RESULTADOS_EVALDOC_PAG";
                objCmd.CommandType = CommandType.StoredProcedure;
                objCmd.Parameters.Add("P_DATA", OracleDbType.Varchar2).Value = p_data;
