...
namespace webapplication.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public CoursesController(IConfiguration iConfig)
        {
        ...
        public String Tabla([FromQuery] HeadersParameters parameters,  [FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                else if(jsondata.p_accion == "sincronizar_BANNER")
                {
                    ...
                    lstSincronizarBanner = objCursoDAO.SincronizarBannerCursos2(p_periodo_objt, p_parte_periodo_objt,p_curso_departamento_objt);
                ...
                if (p_codesString != "[]")
                {
                    ...
                    if (jsondata.p_tabla == "courses")
                    {
                        ...
                        dataTable = objCursoDAO.GetCursosCargados2(p_periodo_objt, p_parte_periodo_objt, p_curso_departamento_objt, p_ind_migrado_objt);
                    }
                    else if (jsondata.p_tabla == "courses_nocargados")
                    {
                        // dataTable = objCSVDAO.GetDataCARGA(jsondata.accion, p_datosString, "");
                        dataTable = objCursoDAO.GetCursosNoCargados2(p_periodo_objt, p_parte_periodo_objt,p_curso_departamento_objt);
                    }
                   else if (jsondata.p_tabla == "sections")
                    {
                        // dataTable = objCSVDAO.GetDataCARGA(jsondata.accion, p_datosString, "");
                ...
                foreach (DataRow dr in dt_periodo.Rows)
                  {
                    ...
                    do
                    {
                        ...
                        ResponseApi rpt_curso_API = objCanvasAPICourse.cursos_canvas_paginados_by_periodo(periodo_id.ToString(), i.ToString());
                        ...
                        if (rpt_curso_API.success == (int)ResponseCode.R200)
                        {
                            ...
                            {
                                String code = curso_api.sis_course_id;
        ...
        public String Migrar([FromQuery] HeadersParameters parameters, [FromBody] dynamic data)
        {
            ...
            try
            {
                        ...
                        else
                        {
                            ...
                            if (numero_codigos > 101)
                            {
                                ...
                                do
                                {
                                    ...
                                    ResponseApi rpt_curso_API2 = objCanvasAPICourse.cursos_canvas_paginados_by_periodo(periodo_id.ToString(), i.ToString());
                            ...
                            else
                            {
                                ...
                                foreach (p_codesModel p_code in lstCodes)
                                {
                                    ...
                                    ResponseApi rpt_curso_API3 = objCanvasAPICourse.get_course_by_sis(code);


                                    if (rpt_curso_API3.success == (int)ResponseCode.R200)
                                    {

                                        CursoCanvas curso_api = rpt_curso_API3.data;
                            ...
                            foreach (List<p_codesModelCanvas> list_p_code in list_ListCodes_Migrados)
                            {
                                ...
                                lstSincronizarCursos = objCursoDAO.SincronizarCursoCargado(jsoncodes, "[]", jsondata.p_usuario,"A");
                ...
                else if (jsondata.p_accion == "migrar_UNO")
                {
                    ...
                    string periodo_externo_sis =  dt_course.Rows[0]["PERIODO_EXTERNO"].ToString();



                    ResponseApi rpt_periodo_API = objCanvasAPITerm.periodo_by_sis_term_id(periodo_externo_sis, course_account_id.ToString());
                    if (rpt_periodo_API.success != (int)ResponseCode.R200)
                    {
                        return FormatRespuestaJSON((int)ResponseCode.R500, "No se encontro el periodo del Curso", "[]");
                    }
                    PeriodoCanvas PeriodoCanvas = rpt_periodo_API.data;
                    ...
                    BodyFormCurso body_curso = new BodyFormCurso
                    {
                        ...
                        sis_course_id = curso_sis,
                        default_view = "assignments",
                        term_id = periodo_id.ToString()
                    };

                    ResponseApi rpt_curso_API = objCanvasAPICourse.crear_curso(body_curso);
                    if (rpt_curso_API.success != (int)ResponseCode.R200)
                    {
                        return FormatRespuestaJSON((int)ResponseCode.R500, rpt_curso_API.message, "[]");
                    }
