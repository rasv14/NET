...
{
    public class CanvasAPIEnrollments
    {

        public CanvasAPIEnrollments(IConfiguration configuration)
        {
        ...
        public ResponseApi get_section_by_sis(String p_code_course)
        {
            string respuesta;
            try
            {
                ...
                string url_api = Configuration.GetSection("MySettings").GetSection("urlCANVASUPAO").Value + "/api/v1/sections/sis_section_id:" + p_code_course+ "?include=total_students"; //"https://upao.instructure.com/api/v1/courses"; 
                ...
                var splashInfo = JsonConvert.DeserializeObject<SeccionCanvas>(respuesta);
        ...
        public ResponseApi get_users_enrollments_by_course_rol_paginado(String p_sis_curso, String p_rol, String page = "1", String per_page = "100")
        {
            string respuesta;
            try
            {
                ...
                string url_api = Configuration.GetSection("MySettings").GetSection("urlCANVASUPAO").Value + "/api/v1/courses/sis_course_id:" + p_sis_curso + "/users?include[]=enrollments&enrollment_type[]=" + p_rol + "&page=" + page + "&per_page=" + per_page; //"https://upao.instructure.com/api/v1/courses"; 
            ...
            public ResponseApi get_section_by_curso_sis(String p_code_course)
        {
            string respuesta;
            try
            {
                ...
                string url_api = Configuration.GetSection("MySettings").GetSection("urlCANVASUPAO").Value + "/api/v1/courses/sis_course_id:" + p_code_course + "/sections?page=1&per_page=100"; //"https://upao.instructure.com/api/v1/courses"; 
        ...
        public ResponseApi crear_enrollment2(BodyFormEnrollment enrollment, int course_id)
        {
            string respuesta;
            HttpWebResponse response;
            StreamReader reader;
            ...
            try
            {
                string URL_API_CANVAS = Configuration.GetSection("MySettings").GetSection("urlCANVASUPAO").Value + "/api/v1/courses/" + course_id + "/enrollments";
                // string URL_API_CANVAS = "https://upao.beta.instructure.com/api/v1/accounts/" + curso.account_id + "/courses";
                tRequest = WebRequest.Create(URL_API_CANVAS) as HttpWebRequest;
                tRequest.Method = "POST";
                tRequest.ContentType = "application/x-www-form-urlencoded";
                ...
                string postString = string.Format("enrollment[user_id]={0}&enrollment[type]={1}&enrollment[enrollment_state]={2}&enrollment[course_section_id]={3}", enrollment.user_id, enrollment.type, enrollment.enrollment_state,enrollment.course_section_id);
                ...
                if ((int)response.StatusCode == 200)
                {
                    EnrollmentCanvas jsonCurso = JsonConvert.DeserializeObject<EnrollmentCanvas>(respuesta);
                    return new ResponseApi { success = (int)ResponseCode.R200, message = "OK", data = jsonCurso };
                    // return new ResponseApi { success = (int)ResponseCode.R200, message = "OK", data = jsonCurso };
                }
