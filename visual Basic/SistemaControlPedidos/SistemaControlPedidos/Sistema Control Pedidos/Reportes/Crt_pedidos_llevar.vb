...
Public Class Crt_pedidos_llevar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Control_Pedidos.Crt_pedidos_llevar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrt_pedidos_llevar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crt_pedidos_llevar = New Crt_pedidos_llevar()
        rpt.Site = Me.Site
        Return rpt
    End Function
