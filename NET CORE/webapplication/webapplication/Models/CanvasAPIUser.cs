...
namespace webapplication.Models
{
    public class CanvasAPIUser
    {
        ...
        public CanvasAPIUser(IConfiguration configuration)
        {
        ...
        public ResponseApi cursos_usuario_canvas_paginados(String numeropaginas, String id_usuario, String numeroxpagina = "100" )
        {
            string respuesta;
            try
            {
                ...
                string url_api = Configuration.GetSection("MySettings").GetSection("urlCANVASUPAO").Value + "/api/v1/users/" + id_usuario + "/courses?page=" + numeropaginas + "&per_page=" + numeroxpagina; //"https://upao.instructure.com/api/v1/courses"; 
