...
namespace webapplication.Models
{
    public class CursoDAO
    {
        ...
        public CursoDAO(IConfiguration configuration)
        {
        ...
        public DataTable GetSeccionesCargados2(String p_periodo, String p_parte_periodo, String p_carrera, String p_ind_migrado = "", String p_sis = "")
        {
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                //COMMENT_BDTEST: objCmd.CommandText = "COMUMGR.PKC_UPAO_CANVAS_CSV.PKC_GET_CSV";
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_CANV_LISTA_SEC_CARG2";
                objCmd.CommandType = CommandType.StoredProcedure;
                objCmd.Parameters.Add("P_PERIODO", OracleDbType.Varchar2).Value = p_periodo;
                objCmd.Parameters.Add("P_PARTE_PERIODO", OracleDbType.Varchar2).Value = p_parte_periodo;
                objCmd.Parameters.Add("P_CARRERA", OracleDbType.Varchar2).Value = p_carrera;
                objCmd.Parameters.Add("P_IND_MIGRADO", OracleDbType.Varchar2).Value = p_ind_migrado;
                objCmd.Parameters.Add("P_SIS", OracleDbType.Varchar2).Value = p_sis;
                objCmd.Parameters.Add("CURSOR_OUT", OracleDbType.RefCursor).Direction = ParameterDirection.Output;
        ...
        public DataTable GetCursosCargados2(String p_periodo, String p_parte_periodo, String p_carrera, String p_ind_migrado = "")
        {
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                //COMMENT_BDTEST: objCmd.CommandText = "COMUMGR.PKC_UPAO_CANVAS_CSV.PKC_GET_CSV";
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_CANV_LISTA_CURSOS_CARG2";
                objCmd.CommandType = CommandType.StoredProcedure;
                objCmd.Parameters.Add("P_PERIODO", OracleDbType.Varchar2).Value = p_periodo;
                objCmd.Parameters.Add("P_PARTE_PERIODO", OracleDbType.Varchar2).Value = p_parte_periodo;
                objCmd.Parameters.Add("P_CARRERA", OracleDbType.Varchar2).Value = p_carrera;
        ...
        public DataTable GetCursosNoCargados2(String p_periodo, String p_parte_periodo, String p_carrera)
        {
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                //COMMENT_BDTEST: objCmd.CommandText = "COMUMGR.PKC_UPAO_CANVAS_CSV.PKC_GET_CSV";
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_CANV_LISTA_CURSOS_PROG2";
                objCmd.CommandType = CommandType.StoredProcedure;
                objCmd.Parameters.Add("P_PERIODO", OracleDbType.Varchar2).Value = p_periodo;
                objCmd.Parameters.Add("P_PARTE_PERIODO", OracleDbType.Varchar2).Value = p_parte_periodo;
                objCmd.Parameters.Add("P_CARRERA", OracleDbType.Varchar2).Value = p_carrera;
        ...
        public List<string> SincronizarBannerCursos2(String p_periodo, String p_parte_periodo, String p_carrera)
        {
            List<string> Result = new List<string>();
            String msg, result, newid;
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                //COMMENT_BDTEST: objCmd.CommandText = "COMUMGR.PKC_UPAO_CANVAS_CSV.PKC_GET_CSV";
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_CANV_SINCRONIZAR_BANNER2";
                objCmd.CommandType = CommandType.StoredProcedure;
                objCmd.Parameters.Add("P_PERIODO", OracleDbType.Varchar2).Value = p_periodo;
                objCmd.Parameters.Add("P_PARTE_PERIODO", OracleDbType.Varchar2).Value = p_parte_periodo;
                objCmd.Parameters.Add("P_CARRERA", OracleDbType.Varchar2).Value = p_carrera;
        ...
        public List<string> ActualizarCursoCargado(string p_accion, string p_data, string p_codes)
        {
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_ACTUALIZAR_CURSO_CARG";
                objCmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<string> SincronizarCursoCargado(string p_migrados, string p_nomigrados, string p_usuario, string p_modo_migracion="M")
        {
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_SINCRONIZAR_CURSO_CARG";
                objCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetReporteInconsistencias(String p_periodo, String p_parte_periodo, String p_carrera)
        {
            ...
            using (OracleConnection objConn = new OracleConnection(objConexion.GetConexion("banner")))
            {
                ...
                objCmd.Connection = objConn;
                //COMMENT_BDTEST: objCmd.CommandText = "COMUMGR.PKC_UPAO_CANVAS_CSV.PKC_GET_CSV";
                objCmd.CommandText = "CANVMGR.PKC_INTEGRACION_CANVAS.PC_CANV_CUR_REP_INCONS";
                objCmd.CommandType = CommandType.StoredProcedure;
                objCmd.Parameters.Add("P_PERIODO", OracleDbType.Varchar2).Value = p_periodo;
                objCmd.Parameters.Add("P_PARTE_PERIODO", OracleDbType.Varchar2).Value = p_parte_periodo;
                objCmd.Parameters.Add("P_CARRERA", OracleDbType.Varchar2).Value = p_carrera;
