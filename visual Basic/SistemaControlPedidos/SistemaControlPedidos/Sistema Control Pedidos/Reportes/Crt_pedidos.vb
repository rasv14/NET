...
Public Class Crt_pedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Control_Pedidos.Crt_pedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrt_pedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crt_pedidos = New Crt_pedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
